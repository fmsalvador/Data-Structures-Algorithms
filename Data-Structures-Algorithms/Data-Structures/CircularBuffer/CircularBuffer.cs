...
namespace Data_Structures_Algorithms.Data_Structures
{
    ...
    public class CircularBuffer<T> //T accepts any kind of type/data
    {
        ...
        public void Test()
        {
            ...
            Console.WriteLine("Initial buffer: ");
            PrintBuffer(buffer);
            ...
            Console.WriteLine("Adding a 7 elements to a 5 elements capacity buffer:");
            PrintBuffer(buffer);


            buffer.PopFront();
            Console.WriteLine("Buffer.PopFront():");
            PrintBuffer(buffer);


            buffer.PopBack();
            Console.WriteLine("Buffer.PopBack():");
            PrintBuffer(buffer);
            ...
            Console.WriteLine("Buffer.PushFront() the elementes {2,1,0}:");
            PrintBuffer(buffer);
        ...
        public CircularBuffer(int capacity, T[] items)
        {
            ...
            System.Array.Copy(items, _buffer, items.Length);
            _size = items.Length;
